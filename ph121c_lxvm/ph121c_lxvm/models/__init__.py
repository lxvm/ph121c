"""Defines the following physics models:

- Transverse-Field Ising models
  - x basis
  - z basis
- Toy Rydberg atom model

On TFIM:

These modules makes available functions for calculating Hamiltonians of 1D TFIMs
...
ph121c_lxvm_fortran_tfim_? package, also imported in ph121c_lxvm.fortran.
